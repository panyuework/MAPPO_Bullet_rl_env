...
class x_mycar2:
    def __init__(self, client, location):
        ...
        # self.x10car_v0 = p.loadURDF(fileName=f_name, basePosition=location,
    ...
    def generate_car(self):
        ...
        x = random.uniform(-5, 5)  # 随机生成 x 坐标
        y = random.uniform(-5, 5)  # 随机生成 y 坐标
        orientation = random.uniform(0, 2 * math.pi)  # 随机生成朝向角度（弧度制）
    ...
    def get_distance(self):
        rayFrom = []
        rayTo = []
        numRays = 93  # number of lidar points
